      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-white">Kontaktieren Sie mich.</h2>
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Sie haben Fragen zu meinen Dienstleistungen oder möchten Sich ein Angebot einholen? <br />Kontaktieren Sie mich gerne per Mail. Telefon oder über das Kontaktformular und ich werde mich bei Ihnen melden. Ich freue mich auf Ihre Anfrage!
            </p>
            <dl className="mt-10 space-y-4 text-base leading-7 text-gray-300">
              ...
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a className="hover:text-white" href="mailto:hausmeisterservice.p.eckstein@gmail.com">
                    hausmeisterservice.p.eckstein@gmail.com
                  </a>
                </dd>
              </div>
            </dl>
