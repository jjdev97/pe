...
export default function Hero() {
  ...
  <header className="absolute inset-x-0 top-0 z-50">
    <div className="mx-auto max-w-7xl">
      <div className="px-4 pt-4 lg:max-w-2xl lg:px-8 lg:pr-0">
        <nav className="flex items-center justify-between lg:justify-start" aria-label="Global">
          ...
          <button
            type="button"
            className="-m-2 rounded-md p-2 text-gray-700 lg:hidden"
  ...
  <div className="relative">
    <div className="mx-auto max-w-7xl">
      <div className="relative z-10 pt-8 lg:w-full lg:max-w-2xl">
        ...
        <div className="relative px-4 py-16 sm:py-20 lg:px-8 lg:py-28 lg:pr-0">
